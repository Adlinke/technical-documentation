...
metadata:
  robots: index
---
Browser access allows human users to interact with Akeyless through the web-based console. This access path is primarily used for administration, configuration, and visibility into secrets, keys, certificates, and access policies.
